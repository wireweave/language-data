...
describe('Utils', () => {
  ...
  it('getAttributeTypeLabel should format types', () => {
    expect(getAttributeTypeLabel({ name: 'x', type: 'boolean', description: '', example: '' })).toBe('boolean');
    expect(getAttributeTypeLabel({ name: 'x', type: 'number', description: '', example: '' })).toBe('number');
    expect(getAttributeTypeLabel({ name: 'x', type: 'string', description: '', example: '' })).toBe('string');
    expect(getAttributeTypeLabel({ name: 'x', type: 'enum', values: ['a', 'b'], description: '', example: '' })).toBe('a | b');
  });

  it('formatAttributeValues should format values', () => {
    expect(formatAttributeValues({ name: 'x', type: 'boolean', description: '', example: '' })).toContain('boolean');
    expect(formatAttributeValues({ name: 'x', type: 'enum', values: ['a', 'b'], description: '', example: '' })).toContain('a | b');
  });
